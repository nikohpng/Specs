Pod::Spec.new do |spec|
    ...
    spec.homepage     = "https://github.com/nikohpng/Specs"
    spec.license      = { :type => 'BSD', :file => 'WebRTC.xcframework/LICENSE' }
    spec.author       = "hpng"
    spec.ios.deployment_target = '10.0'
    spec.osx.deployment_target = '10.11'
  
    spec.source       = { :http => "https://github.com/nikohpng/Specs/releases/download/104.5112.12/WebRTC.xcframework.zip" }
